...
void m2_forward_unit(){
    ...
    set_servo_pos(1, MIN_2, ARM_SPEED);
...
void m2_backward_unit(){
    ...
    set_servo_pos(1, MAX_2, ARM_SPEED);
...
void m3_down_unit(){
    ...
    set_servo_pos(1, MIN_3, ARM_SPEED);
...
void m4_up_unit(){
    ...
    set_servo_pos(1, MAX_4, ARM_SPEED);
...
void m4_down_unit(){
    ...
    set_servo_pos(1, MIN_4, ARM_SPEED);
...
void pause(){
    set_servo_pos(1, cur_pos_1, 0);
	set_servo_pos(2, cur_pos_2, 0);
	set_servo_pos(3, cur_pos_3, 0);
	set_servo_pos(4, cur_pos_4, 0);
	set_servo_pos(5, cur_pos_5, 0);
}
